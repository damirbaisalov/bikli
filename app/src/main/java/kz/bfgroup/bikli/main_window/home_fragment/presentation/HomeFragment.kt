...
class HomeFragment: Fragment() {
    ...
    private fun initViews() {
        bikliHelperOn = view?.findViewById(R.id.fragment_home_bikli_helper_linear_layout)!!
        bikliHelperOff = view?.findViewById(R.id.fragment_home_hand_help_linear_layout)!!
    }
